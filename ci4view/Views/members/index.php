		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo site_url('members/view/'.$row['id']); ?>" class="btn btn-primary" style="height: 30px; width: 100px;"><i class="fa fa-eye"></i></a>
						<a href="<?php echo site_url('members/edit/'.$row['id']); ?>" class="btn btn-warning" style="height: 30px; width: 100px;"><i class="fa fa-edit"></i></a>
						<a href="<?php echo site_url('members/delete/'.$row['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')" style="height: 30px; width: 100px;"><i class="fa fa-trash"></i></a>
					</td>
				</tr>
				<?php } }else{ ?>
