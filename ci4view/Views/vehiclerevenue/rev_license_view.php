      ...
      <div class="col-md-12 mb-3">
         <div class="card h-100">
            <div class="card-body">
               ...
               <h5 class="card-title">Revenue License Details</h5>
			   <div class="float-right">
			   		   <a href="<?php echo base_url();?>VehicleRevenue/add" class="btn btn-info"><i class="fa fa-pencil"></i> Add New Revenue certificate</a>
			   </div>
			   <br><br>
               <table id="vehicle_revenue" class="display nowrap" style="width:100%" >
