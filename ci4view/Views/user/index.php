		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo site_url('members/view/'.$row['id']); ?>" class="btn btn-primary" style="height: 30px; width: 100px;">view</a>
						<a href="<?php echo site_url('members/edit/'.$row['id']); ?>" class="btn btn-warning" style="height: 30px; width: 100px;">edit</a>
						<a href="<?php echo site_url('members/delete/'.$row['id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?')" style="height: 30px; width: 100px;">delete</a>
					</td>
				</tr>
				<?php } }else{ ?>
