						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="itemname" class="col-form-label"> Itemname: </label>
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="itemamount" class="col-form-label"> Itemamount: </label>
...
<script>
  ...
  function save(idorderitems) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof idorderitems === 'undefined' || idorderitems < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #idorderitems").val(response.idorderitems);
			$("#data-form #itemname").val(response.itemname);
			$("#data-form #qty").val(response.qty);
			$("#data-form #itemamount").val(response.itemamount);
