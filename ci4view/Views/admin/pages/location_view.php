						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="locationname" class="col-form-label"> Locationname: </label>
									<input type="text" id="locationname" name="locationname" class="form-control" placeholder="Locationname" minlength="0"  maxlength="45" >
								</div>
							</div>
<div class="col-md-12">
						<div class="form-group mb-3">
							<label for="location_is_active" class="col-form-label"> Location is active: </label>
...
<script>
  ...
  function save(idLocation) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof idLocation === 'undefined' || idLocation < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #idLocation").val(response.idLocation);
			$("#data-form #locationname").val(response.locationname);
			$("#data-form #location_is_active").val(response.location_is_active);
