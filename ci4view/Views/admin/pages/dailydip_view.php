        ...
        <div class="card-header">
          <div class="row">
            <div class="col-10 mt-2">
              <h3 class="card-title">dailydip</h3>
            </div>
            <div class="col-2">
...
<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="checkdate" class="col-form-label"> Checkdate: </label>
									<input type="date" id="checkdate" name="checkdate" class="form-control" dateISO="true" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="petrol" class="col-form-label"> Petrol: </label>
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="superdiesel" class="col-form-label"> Superdiesel: </label>
									<input type="number" id="superdiesel" name="superdiesel" class="form-control" placeholder="Superdiesel" minlength="0"  maxlength="11" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="superpetrol" class="col-form-label"> Superpetrol: </label>
...
<script>
  ...
  function save(iddailydip) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof iddailydip === 'undefined' || iddailydip < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #iddailydip").val(response.iddailydip);
			$("#data-form #checkdate").val(response.checkdate);
			$("#data-form #petrol").val(response.petrol);
			$("#data-form #diesel").val(response.diesel);
			$("#data-form #superdiesel").val(response.superdiesel);
			$("#data-form #superpetrol").val(response.superpetrol);
