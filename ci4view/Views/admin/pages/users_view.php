...
<input type="hidden" id="idUsers" name="idUsers" class="form-control" placeholder="IdUsers" maxlength="11" required>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="isadmin" class="col-form-label"> Isadmin: </label>
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="isdealer" class="col-form-label"> Isdealer: </label>
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="isdriver" class="col-form-label"> Isdriver: </label>
...
<script>
  ...
  function save(idUsers) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof idUsers === 'undefined' || idUsers < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #idUsers").val(response.idUsers);
			$("#data-form #firstname").val(response.firstname);
			$("#data-form #lastname").val(response.lastname);
			$("#data-form #email").val(response.email);
			$("#data-form #password").val(response.password);
			$("#data-form #isadmin").val(response.isadmin);
			$("#data-form #isdealer").val(response.isdealer);
			$("#data-form #isdriver").val(response.isdriver);
			$("#data-form #phonenumber").val(response.phonenumber);
