        ...
        <div class="card-header">
          <div class="row">
            <div class="col-10 mt-2">
              <h3 class="card-title">loginlog</h3>
            </div>
            <div class="col-2">
...
<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="logindate" class="col-form-label"> Logindate: </label>
...
<div class="col-md-12">
						<div class="form-group mb-3">
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="otpcode" class="col-form-label"> Otpcode: </label>
									<input type="text" id="otpcode" name="otpcode" class="form-control" placeholder="Otpcode" minlength="0"  maxlength="45" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="iscorrect" class="col-form-label"> Iscorrect: </label>
...
<script>
  ...
  function save(idloginlog) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof idloginlog === 'undefined' || idloginlog < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #idloginlog").val(response.idloginlog);
			$("#data-form #logindate").val(response.logindate);
			$("#data-form #Users_idUsers").val(response.Users_idUsers);
			$("#data-form #otpcode").val(response.otpcode);
			$("#data-form #iscorrect").val(response.iscorrect);
