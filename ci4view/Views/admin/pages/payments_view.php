...
<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="paymentdate" class="col-form-label"> Paymentdate: </label>
									<input type="date" id="paymentdate" name="paymentdate" class="form-control" dateISO="true" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="isreceived" class="col-form-label"> Isreceived: </label>
...
<div class="col-md-12">
						<div class="form-group mb-3">
							<label for="paymentmethod_idpaymentmethod" class="col-form-label"> Paymentmethod idpaymentmethod: <span class="text-danger">*</span> </label>
...
<div class="col-md-12">
						<div class="form-group mb-3">
							<label for="orders_idorders" class="col-form-label"> Orders idorders: <span class="text-danger">*</span> </label>
...
<script>
  ...
  function save(idpayments) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof idpayments === 'undefined' || idpayments < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #idpayments").val(response.idpayments);
			$("#data-form #paymentdate").val(response.paymentdate);
			$("#data-form #isreceived").val(response.isreceived);
			$("#data-form #paymentmethod_idpaymentmethod").val(response.paymentmethod_idpaymentmethod);
			$("#data-form #amount").val(response.amount);
			$("#data-form #orders_idorders").val(response.orders_idorders);
