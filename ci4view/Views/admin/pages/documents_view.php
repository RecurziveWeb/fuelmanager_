						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="text" id="type" name="type" class="form-control" placeholder="Type" minlength="0"  maxlength="45" >
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
...
<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="uploaddate" class="col-form-label"> Uploaddate: </label>
...
<script>
  ...
  function save(iddocuments) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof iddocuments === 'undefined' || iddocuments < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          			$("#data-form #iddocuments").val(response.iddocuments);
			$("#data-form #type").val(response.type);
			$("#data-form #filename").val(response.filename);
			$("#data-form #uploaddate").val(response.uploaddate);
