...
class Employeetype extends BaseController
{
	...
	public function index()
	{
		...
		echo view("admin/pages/employeetype_view",$data);
...
$fields['employeetype'] = $this->request->getPost('employeetype');
	...
	public function delete()
	{
		...
		$id = $this->request->getPost('idemployeetype');
	...
	public function getAll()
	{
		...
		$result = $this->employeetypeModel->select()->findAll();

		
		foreach ($result as $key => $value) {
							
			$ops = '<div class="btn-group">';
			$ops .= '<a class="btn btn-info" onClick="save('. $value->idemployeetype .')"><i class="fa-solid fa-pen-to-square"></i>   ' .  lang("App.edit")  . '</a>';
			$ops .= '</div>';

			$data['data'][$key] = array(
				$value->idemployeetype,
$value->employeetype,
	...
	public function getOne()
	{
		...
		if ($this->validation->check($id, 'required|numeric')) {
			...
			$data = $this->employeetypeModel->where('idemployeetype' ,$id)->first();
