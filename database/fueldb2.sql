...
(1, 'Maharagama Filling Station', '321 Railway Avenue', 2, 0, 0, 0, 0, 'Western Province', 2, 0, 'none', 0),
(2, 'Maharagama Filling Station', '321 Railway Avenue', 3, 6600, 6600, 6600, 6600, 'Western Province', 3, 0, 'none', 0);
...
INSERT INTO `materialprice` (`idmaterialprice`, `materialtype`, `materialprice`, `material_is_active`, `isdelete`) VALUES
(1, 'Petrol', 250, '1', 0);
...
(2, 'Thilina', 'Abeysinghe', 'recurzivewebdesign@gmail.com', 'sameera', 0, 1, 0, '779798118', 1),
(3, 'Thilina', 'Abeysinghe', 'admin', 'sameera', 0, 1, 0, '779798118', 0),
(5, 'Thilina', 'Abeysinghe', 'tsa@gmail.com', 'sameera', 0, 0, 0, '779798118', 1),
(7, 'Thilina', 'Abeysinghe', 'admin@gmail.com', 'sameera', 1, 0, 0, '1215646', 0);
...
(1, '25558', '588', '2021-06-18 00:00:00', 2, 25, '1', '1', 1, 1, 0);
...
INSERT INTO `vehicle_calibration_certificate` (`idvehicle_calibration_certificate`, `vehicle_calibration_certificate_name`, `vehicle_calibration_certificate_issue_date`, `vehicle_calibration_certificate_expiry_date`, `vehicle_calibration_certificate_is_active`, `vehicle_idvehicle`, `isdelete`) VALUES
(1, 'ISO124', '2023-10-18 00:00:00', '2023-10-18 00:00:00', '1', 1, 0);
...
(2, '111d', '2023-10-18 00:00:00', '2023-10-18 00:00:00', '1', 1, 0);
