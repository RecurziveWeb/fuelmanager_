...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2023 at 03:25 PM
...
(14, 'Thilina', 'Abeysinghe', 'thilina@recurzive.com', '247758853ccfcf109a492afe1031862d0e2625b7a976d0497eab02d99fd24fca', 0, 0, 0, '0717699107', 0);
...
--
ALTER TABLE `dailydip`
  MODIFY `iddailydip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `employeetype`
  MODIFY `idemployeetype` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `fillingstation`
--
ALTER TABLE `fillingstation`
  MODIFY `idfillingstation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
