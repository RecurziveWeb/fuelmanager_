<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <!-- error message start-->
      ...
      <hr class="my-0">
      <div class="card-body">
         <form method="POST" action="<?php echo base_url();?>index.php/documents/update/<?php echo $primaryid; ?>">
            <div class="row">
            <input type="hidden" id="iddocuments" name="iddocuments" class="form-control" placeholder="Iddocuments" maxlength="11" required>
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="text" id="filename" name="filename" class="form-control" value="<?php echo $documents->filename; ?>">
								</div>
							</div>
<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="uploaddate" class="form-label"> Uploaddate: </label>
									<input type="date" id="uploaddate" name="uploaddate" class="form-control" dateISO="true"  value="<?php echo $documents->uploaddate; ?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
						...
						<div class="form-group mb-3">
							...
							<select id="fillingstation_idfillingstation" name="fillingstation_idfillingstation" class="form-select" required>
								<?php foreach($fillingstation as $data){ ?>
									if(strcmp($documents->fillingstation_idfillingstation,$data->keyid)==0){
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="text" id="approvedby" name="approvedby" class="form-control" value="<?php echo $documents->approvedby; ?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
