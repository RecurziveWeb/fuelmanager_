<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <!-- error message start-->
      ...
      <hr class="my-0">
      <div class="card-body">
         <form method="POST" action="<?php echo base_url();?>index.php/payments/update/<?php echo $primaryid; ?>">
            <div class="row">
...
<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="date" id="paymentdate" name="paymentdate" class="form-control" dateISO="true"  value="<?php echo $payments->paymentdate; ?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
...
<div class="col-md-12">
						<div class="form-group mb-3">
							...
							<select id="paymentmethod_idpaymentmethod" name="paymentmethod_idpaymentmethod" class="form-select" required>
								<?php foreach($paymentmethod as $data){ ?>
									if(strcmp($payments->paymentmethod_idpaymentmethod,$data->keyid)==0){
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="number" id="amount" name="amount" class="form-control" value="<?php echo $payments->amount; ?>">
								</div>
							</div>
<div class="col-md-12">
						<div class="form-group mb-3">
							...
							<select id="orders_idorders" name="orders_idorders" class="form-select" required>
								<?php foreach($orders as $data){ ?>
									if(strcmp($payments->orders_idorders,$data->keyid)==0){
										<option value="<?php echo $data->keyid; ?>" selected><?php echo $data->keyvalue; ?></option>
									}else{
										<option value="<?php echo $data->keyid; ?>"><?php echo $data->keyvalue; ?></option>	
									}
