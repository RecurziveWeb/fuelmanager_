<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <!-- error message start-->
      ...
      <h5 class="card-header">Add vehicle_type Details</h5>
      
      <hr class="my-0">
      <div class="card-body">
         <form method="POST" action="<?php echo base_url();?>index.php/vehicle_type/update/<?php echo $primaryid; ?>">
            <div class="row">
            <input type="hidden" id="idvehicle_type" name="idvehicle_type" class="form-control" placeholder="Idvehicle type" maxlength="11" required>
							<div class="col-md-12">
								<div class="form-group mb-3">
									...
									<input type="number" id="vehicle_capacity" name="vehicle_capacity" class="form-control" value="<?php echo $vehicle_type->vehicle_capacity; ?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group mb-3">
